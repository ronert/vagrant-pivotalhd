...
sshpass -p gpadmin ssh -o StrictHostKeyChecking=no gpadmin@phd1 'source /usr/local/hawq/greenplum_path.sh; cd /vagrant/plr/plr; /vagrant/plr/plr/plr_install.sh -f /home/gpadmin/HAWQ_Segment_Hosts.txt; rm -rf /vagrant/plr'
